...
RADAR_CFG_LIST = [
    {'name'          : 'IWR1843_Ori',
     'cfg_port_name' : config.cfg_port_name,
     'data_port_name': config.data_port_name,
     'cfg_file_name' : './cfg/IWR1843_3D_10fps_9db.cfg',  # always use 3D data as input
...
FRAME_POST_PROCESSOR_CFG = {  # post process config
    ...
    'FPP_global_xlim' : (-2, 0.5),  # the x-direction limit for merged cloud points from all radars, set as [a, b), from global view
    'FPP_global_ylim' : (0, 6),
